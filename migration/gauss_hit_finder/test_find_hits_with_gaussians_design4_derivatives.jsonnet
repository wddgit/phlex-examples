{
  ...
  modules: {
    ...
    // Candidate hit finding using derivative method: wire_roi_data -> merge_hit_candidate_vec
    cand_hit_derivative_cpp: {
      cpp: 'cand_hit_derivative_hof',
      layer_roi: 'roi',
      min_delta_ticks: 0,
      min_delta_peaks: 2.0,
      min_hit_height: 1.0,
      num_intervening_ticks: 6,
    },
    ...
    find_hits_with_gaussians_design4_cpp: {
      ...
      layer_roi: 'roi',
      cand_hit_finder: 'cand_hit_derivative',
    ...
    print_hits_to_file_cpp: {
      ...
      layer: 'spill',
      filename_prefix: 'hits_design4_derivatives',
    },
  },
}
